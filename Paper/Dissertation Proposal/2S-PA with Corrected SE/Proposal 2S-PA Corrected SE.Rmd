---
title             : "Two-Stage Path Analysis: Corrected Standard Error"
...
I will use `R 4.3.2` (R Core Team, 2023) to conduct the simulation studies in this project. Specifically, the SEM and 2S-PA models will be implemented through the R package `lavaan` (Rosseel, 2012) and user-defined functions, while SAM models will be implemented using `sam` function in `lavaan`. The simulation design will be structured and conducted using the R package `SimDesign` (Chalmers, 2020).
